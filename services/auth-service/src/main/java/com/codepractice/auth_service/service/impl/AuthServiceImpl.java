...
import com.codepractice.auth_service.client.UserServiceClient;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void register(RegisterRequest request) {
        ...
        UserClientRequest externalUser = buildExternalUser(savedUser);
    ...
    private UserClientRequest buildExternalUser(User user) {
